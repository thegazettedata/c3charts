...
var json_value = 'Iowa teacher salaries';
var json_value2 = 'U.S. teacher salaries';
...
var chart = c3.generate({
    ...
    data: {
    	...
    	color: function (color, value) {
            ...
            if (value["id"] == "Iowa teacher salaries") {
                return chart_color2;
            } 
            else{
                return chart_color;
    ...
    tooltip: {
        contents: function (value, defaultTitleFormat, defaultValueFormat, color) {
            ...
            tooltip += '$' + commaSeparateNumber(salValue1) + ' ' + 'for nation';
            tooltip += '</td>';
            tooltip += '</tr>'
            ...
            tooltip += '$' + commaSeparateNumber(salValue2) + ' ' + 'for Iowa';
            tooltip += '</td>';
...
$(document).ready(function() {
    ...
    $("body").mouseleave(function(){
        ga('send', 'event', 'C.O.Ed - teacher salaries', 'Chart touched');
    });
});